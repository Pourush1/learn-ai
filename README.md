...
| ---- | -------------------- | --------------------------------------------------------------- |
| 📺   | Videos               | YouTube videos, video playlists, and video tutorials            |
| 🎓   | Courses              | Structured courses from Coursera, Deeplearning.ai, universities |
| 📚   | Documentation/Guides | GitHub repositories, comprehensive guides, documentation        |
| 📄   | Articles/Papers      | Blog posts, research papers, articles, and written content      |
| 🛠️   | Tools/Frameworks     | Software tools, libraries, frameworks, and development tools    |
| 🤖   | AI Models/Chatbots   | LLM models, chatbot interfaces, and AI applications             |
| 🔌   | APIs                 | API documentation, services, and integration guides             |
| 💻   | IDEs/Software        | Development environments, editors, and software applications    |
| 📖   | Books                | Published books, textbooks, and comprehensive reading materials |
| 🌐   | Websites/Platforms   | Web platforms, online resources, and community sites            |
| 🎯   | Practice Platforms   | Competition sites, practice platforms, and hands-on learning    |
...
- 🛠️ [TensorFlow](https://www.tensorflow.org/)
